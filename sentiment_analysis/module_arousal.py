...
from arousal_recognition import config

from arousal_recognition.module_AudioTools import generate_spectrograms
...
import arousal_recognition.network_arousal as netArch
